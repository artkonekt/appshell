...
class FilterSetWidgetTest extends TestCase
{
    ...
    {
        $widget = new FilterSet(new AppShell3Theme(), '', new Filters());
    ...
    {
        $widget = FilterSet::create(new AppShell3Theme(), ['route' => '']);
    ...
    {
        $widget = new FilterSet(new AppShell3Theme(), 'appshell.user.index', new Filters());
