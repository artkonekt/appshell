...
use Konekt\AppShell\Contracts\Requests\UpdateInvitation as UpdateInvitationContract;
use Konekt\User\Contracts\UserType;
use Konekt\User\Models\UserTypeProxy;

class UpdateInvitation extends FormRequest implements UpdateInvitationContract
{
    use HasRoles;
