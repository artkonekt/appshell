...
<head>
    ...
    <link href="{{ $apshell->useMix ? mix('/css/appshell.css') : asset('/css/appshell.css')  }}" media="all" type="text/css" rel="stylesheet" />
...
<!-- Scripts -->
<script src="{{ $apshell->useMix ? mix('/js/appshell.js') : asset('/js/appshell.js') }}"></script>
